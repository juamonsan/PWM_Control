...
osThreadId CommunicationsHandle;
...
/* USER CODE BEGIN Header_StartCommunications */
/**
* @brief Function implementing the Communications thread.
* @param argument: Not used
* @retval None
*/
...
void StartCommunications(void const * argument)
{
  ...
  /* USER CODE END StartCommunications */
}
...
/* USER CODE BEGIN Header_StartButtonCheck */
/**
...
void StartButtonCheck(void const * argument)
{
  ...
  /* USER CODE END StartButtonCheck */
}
